...
public class MongoDB {
    ...
    public MongoDB(MobRush inst) {
        String uri = inst.getConfig().getString("mongodb.uri", "mongodb+srv://xopekqq:cy8lCXyUPLccY07y@mobrushcluster.pvdwe.mongodb.net/?retryWrites=true&w=majority&appName=MobRushCluster");
    ...
    public RushPlayer getPlayer(String uuid) {
        ...
        return new RushPlayer(uuid, 0, 0, 1);
    }
